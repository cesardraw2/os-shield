...
Para otimizar a vida útil e performance do SSD, todos os diretórios de escrita massiva, caches globais e repositórios pesados ficam hospedados fisicamente em `/mnt/hd_novo/` e são espelhados na `/home/cesardraw/` através de **Links Simbólicos (Symlinks)**.
